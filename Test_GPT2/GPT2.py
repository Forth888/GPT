...
if __name__ == '__main__':
    ...
    parser.add_argument('--isFirst', default=False, type=bool, action='store', help='Is it is the first tiem to train')
    parser.add_argument('--loadModel', default='mymodel.pt', type=str, action='store', help='Is it is the first tiem to train')
